...
public class PlayHud {
    ...
    public PlayHud(ArrayList<Integer> starCounter, Camera camera) {
        ...
        pauseButton = new Clickable(new Vector3(Game.WIDTH - 60, Game.HEIGHT - 60,0), "navigation.png", "navigation.png");
        this.starCounter = starCounter;
        hudBG = new GameObject(new Vector3(0, Game.HEIGHT-60,0), "bg/playHudBg.png");
        ...
        star = new GameObject(new Vector3(20 + initText.width, Game.HEIGHT - 42,0), "star.png");
        starNO = new GameObject(new Vector3(20 + initText.width, Game.HEIGHT - 42,0), "starNO.png");
    }
    ...
    public void render(SpriteBatch sb){
        ...
        int fontHeight = 20;
        font.draw(sb, initText,  fontHeight, Game.HEIGHT - fontHeight);
        ...
        font.draw(sb, ": ", star.getPosition().x + (star.getBounds().width * 3) + 6, Game.HEIGHT - fontHeight);
        font.draw(sb, timeText, star.getPosition().x + (star.getBounds().width * 3) + 12, Game.HEIGHT - fontHeight);
        font.draw(sb, "s", star.getPosition().x + (star.getBounds().width * 3) + timeText.width + 12, Game.HEIGHT - fontHeight);
