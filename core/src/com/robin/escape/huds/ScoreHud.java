...
public class ScoreHud {
    ...
    public ScoreHud(ArrayList<Integer> starCounter, Camera camera) {
        ...
        nextButton = new Clickable(new Vector3(escape.WIDTH/2 + replayButton.getBounds().width / 2, 10,0), styleManager.getStyle()+ "/button/nextbuttonUnPressed.png", styleManager.getStyle()+ "/button/nextbutton.png");
        ...
        star = new GameObject(new Vector3(10 + initText.width,escape.HEIGHT - 90,0), "star.png");
        starNO = new GameObject(new Vector3(10 + initText.width,escape.HEIGHT - 73,0), "starNO.png");
    ...
    public void render(SpriteBatch sb){
        ...
        font.draw(sb, initText, 10, escape.HEIGHT - 50);
